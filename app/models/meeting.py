...
class Meeting(db.Model):
    ...
    '''id = db.Column('MeetingID', db.Integer, primary_key=True, autoincrement=True)
    type_id = db.Column('MeetingTypeID', db.Integer, db.ForeignKey('meetingtype.MeetingTypeID'))
    start_date = db.Column('StartDate', db.String(256))
    start_time = db.Column('StartTime', db.String(256))
    end_date = db.Column('EndDate', db.String(256))
    end_time = db.Column('EndTime', db.String(256))
    location = db.Column('Location', db.String(256))'''



    def __init__(self, type_id, start_date, start_time,end_date,end_time,location):
